...
public class UAgentInfo {
 ...
 public boolean detectWebOSTV() {
     return userAgent.indexOf(deviceWebOStv) != -1 &&
 ...
 public boolean detectFirefoxOSPhone() {
     ...
     return (userAgent.indexOf(engineFirefox) != -1)
             && (userAgent.indexOf(mobile) != -1);
 ...
 public boolean detectUbuntuPhone() {
     return (userAgent.indexOf(deviceUbuntu) != -1)
             && (userAgent.indexOf(mobile) != -1);
 ...
 public boolean detectMaemoTablet() {
     if (userAgent.indexOf(maemo) != -1) {
         return true;
     } else return userAgent.indexOf(linux) != -1
             && userAgent.indexOf(deviceTablet) != -1
             && !detectWebOSTablet()
             && !detectAndroid();
 }
...
//*****************************
 ...
 public boolean detectMobileQuick() {
     ...
     return (userAgent.indexOf(engineNetfront) != -1)
